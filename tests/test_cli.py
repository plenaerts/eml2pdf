...
class TestGetArgs(unittest.TestCase):
    ...
    def test_convert_dir_debug_html_flag(self):
        ...
        with patch('sys.argv', ['eml2pdf', 'convert_dir', 'input', 'output', '--debug_html']):
            args = get_args()
            self.assertTrue(args.debug_html)

        with patch('sys.argv', ['eml2pdf', 'convert_dir', 'input', 'output', '-d']):
            args = get_args()
            self.assertTrue(args.debug_html)
    ...
    def test_convert_dir_number_of_procs_flag(self):
        ...
        with patch('sys.argv', ['eml2pdf', 'convert_dir', 'input', 'output', '-n', '4']):
            args = get_args()
            self.assertEqual(args.number_of_procs, 4)

        with patch('sys.argv', ['eml2pdf', 'convert_dir', 'input', 'output', '--number-of-procs', '8']):
            args = get_args()
    ...
    def test_convert_dir_page_size_flag(self):
        """Test -p/--page flag."""
        with patch('sys.argv', ['eml2pdf', 'convert_dir', 'input', 'output', '-p', 'letter']):
            args = get_args()
            self.assertEqual(args.page, 'letter')

        with patch('sys.argv', ['eml2pdf', 'convert_dir', 'input', 'output', '--page', 'a3']):
            args = get_args()
            self.assertEqual(args.page, 'a3')

        with patch('sys.argv', ['eml2pdf', 'convert_dir', 'input', 'output', '-p', 'a4 landscape']):
            args = get_args()
    ...
    def test_convert_dir_unsafe_flag(self):
        """Test --unsafe flag."""
        with patch('sys.argv', ['eml2pdf', 'convert_dir', 'input', 'output', '--unsafe']):
            args = get_args()
    ...
    def test_convert_dir_verbose_flag(self):
        """Test -v/--verbose flag."""
        with patch('sys.argv', ['eml2pdf', 'convert_dir', 'input', 'output', '-v']):
            args = get_args()
            self.assertTrue(args.verbose)

        with patch('sys.argv', ['eml2pdf', 'convert_dir', 'input', 'output', '--verbose']):
            args = get_args()
            self.assertTrue(args.verbose)
    ...
    def test_convert_file_debug_html_flag(self):
        ...
        with patch('sys.argv', ['eml2pdf', 'convert_file', 'input.eml', 'output.pdf', '--debug_html']):
            args = get_args()
            self.assertTrue(args.debug_html)

        with patch('sys.argv', ['eml2pdf', 'convert_file', 'input.eml', 'output.pdf', '-d']):
            args = get_args()
            self.assertTrue(args.debug_html)
    ...
    def test_convert_file_page_size_flag(self):
        ...
        with patch('sys.argv', ['eml2pdf', 'convert_file', 'input.eml', 'output.pdf', '-p', 'letter']):
            args = get_args()
            self.assertEqual(args.page, 'letter')

        with patch('sys.argv', ['eml2pdf', 'convert_file', 'input.eml', 'output.pdf', '--page', 'a3']):
            args = get_args()
            self.assertEqual(args.page, 'a3')
    ...
    def test_convert_file_unsafe_flag(self):
        ...
        with patch('sys.argv', ['eml2pdf', 'convert_file', 'input.eml', 'output.pdf', '--unsafe']):
            args = get_args()
            self.assertTrue(args.unsafe)
    ...
    def test_convert_file_verbose_flag(self):
        ...
        with patch('sys.argv', ['eml2pdf', 'convert_file', 'input.eml', 'output.pdf', '--verbose']):
            args = get_args()
            self.assertTrue(args.verbose)
...
class TestMain(unittest.TestCase):
    ...
    def test_main_convert_file_with_debug_html(self, mock_process):
        ...
        with patch('sys.argv', ['eml2pdf', 'convert_file', 'input', 'output', '-d']):
            main()
            call_args = mock_process.call_args[0]

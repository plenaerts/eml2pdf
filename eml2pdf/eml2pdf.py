...
def get_args() -> argparse.Namespace:
    ...
    subparsers = parser.add_subparsers(
        ...
        help='Use {subcommand} --help for options.',
    )

    convert_dir = subparsers.add_parser(
        'convert_dir',
    ...
    convert_dir.add_argument(
        'input_dir', type=Path, help='Directory containing EML files'
    )
    convert_dir.add_argument(
        'output_dir', type=Path, help='Directory for PDF output'
    )
    convert_dir.add_argument(
        '-n',
        '--number-of-procs',
    ...
    convert_file = subparsers.add_parser(
        'convert_file',
        parents=[parent_parser],
        help='Convert a single EML file to a single PDF',
    )
    convert_file.add_argument(
        'input_file', type=Path, help='Input EML file to convert'
    )
    convert_file.add_argument(
        'output_file', type=Path, help='Output PDF file to convert to'
    )
